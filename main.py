...
API_HASH = os.environ.get("API_HASH", "db8aa69c-1c1b-4d4b-a3d9-0af56242eeff") 
...
BOT_USERNAME = os.environ.get("BOT_USERNAME", "cute_pari_ap_bot") 
...
START_IMG1 = os.environ.get("START_IMG1", "https://graph.org/file/5fc8dd23ea909c8818e65.jpg")
